...
純一はConnpassで「iOS Indie Dev LT Night #5」というイベントを見つけた。
...
純一はKeynoteを開いた。デザイナーとしてのスキルが、ここでも活きる。余白を活かしたスライドデザイン、視線誘導を意識したレイアウト、コードブロックのシンタックスハイライト。純一のスライドは、エンジニアが作るものとは明らかに異質だった。
...
参加者は約三十名。純一が第二章で参加したCA.swiftの百名規模とは異なり、個人開発者が中心のアットホームな雰囲気だ。名刺交換の代わりにXのアカウントを交換するのが、この界隈の流儀らしい。

純一は五番目——最後の登壇者だった。前の四人の発表を聴きながら、純一の心臓は加速していく。一人目は天気アプリのウィジェット実装の話。二人目はSwift Concurrencyのベストプラクティス。三人目はApp Storeのレビュー対応の自動化。四人目はVisionProの個人開発体験談。

みんな、自分より遥かに経験豊富に見える。

「次は、水野さんです」

司会者に名前を呼ばれた瞬間、純一の頭が真っ白になった。

足が動く。ステージに向かう。MacBook AirをHDMIケーブルに接続する。Keynoteの最初のスライドが映し出される。

深呼吸。

「初めまして。水野純一と申します。普段はグラフィックデザイン会社で働いています。今日は、デザイナーがゼロからApp Storeにアプリをリリースするまでの七ヶ月間について、お話しします」
...
純一は、初めて「iOSエンジニアのコミュニティ」に受け入れられた感覚を味わった。CA.swiftでは観客席で聴いているだけだった。今日は、ステージの上に立った。五分間だけだったが、純一の言葉が、三十人の開発者に届いた。
...
四月下旬。純一のiPhoneに、村田さんからDMが届いた。

//quote{
純一くん、突然の連絡ですみません。実は、もくもく会をしばらく休止しようと思っています。前から話していた間借りカフェを、本格的に始めることにしました。下北沢のスペースを借りて、週末は自分のカフェとして営業したいんです。もくもく会のスペースを確保するのが難しくなりそうで……本当に申し訳ないです。
//}

純一は何度もそのメッセージを読み返した。

村田さんのもくもく会は、純一にとって「居場所」だった。初めて参加したとき、一人でTodoアプリのコードを書いていた純一に、村田さんが「何作ってるんですか？」と声をかけてくれた。GitHubを教えてくれたのも村田さんだ。CA.swiftのLT会を紹介してくれたのも村田さんだ。

その居場所が、なくなる。

純一は数日間、ぼんやりと過ごした。デザイン会社の仕事をこなし、帰宅後にXcodeを開くが、集中できない。コミュニティのない個人開発は、真っ暗な部屋で一人でコードを書いているようなものだ。
...
//quote{
ぜひ！純一くんがやってくれるなら嬉しい。会場は自分で探す必要があるけど、下北沢だけじゃなくて渋谷とか池袋にもコワーキングスペースのドロップインがあるから。もくもく会の名前は変えてもらって大丈夫だよ。純一くんなりのコミュニティにしてほしい。
//}

純一は決意した。自分でもくもく会を開く。しかし、村田さんの「個人開発者もくもく会」をそのまま引き継ぐのではなく、純一ならではのコミュニティにしたい。
...
純一は驚いた。完全未経験——飲食業の店長から。純一のグラフィックデザイナーからの転身と、境遇が似ている。しかしHaruは純一よりも遥かに先を行っていた。複数のアプリをリリースし、広告収入を得て、技術記事を書いて収益化もしている。
...
純一は思い切って、HaruにDMを送った。

//quote{
初めまして。水野純一と申します。グラフィックデザイナーからiOSエンジニアを目指して学習中です。Haruさんの投稿にいつも勉強させてもらっています。実は近々「iOSエンジニア&デザイナーもくもく会」というイベントを自分で企画しているのですが、もしよかったら参加していただけないでしょうか。
//}

純一は送信ボタンを押した後、すぐに後悔した。面識のない相手にいきなりもくもく会の誘いを送るのは失礼だったかもしれない。

しかし、翌朝、返信が来ていた。

//quote{
純一さん、はじめまして！DMありがとうございます。プロフィール拝見しました。デザイナーからiOS開発、面白い経歴ですね。もくもく会、ぜひ参加させてください！日程決まったら教えてください。
//}
...
定員十名に対して三名。純一は少し落ち込んだ。村田さんのもくもく会は毎回七〜八名は集まっていた。

当日。渋谷のコワーキングスペースに三人が集まった。

Haruは、純一が想像していたよりも穏やかな雰囲気の人だった。年齢は純一より少し上。飲食業の店長を辞めてから独学でプログラミングを始め、三年でiOSアプリを十二本リリースしたという。
...
三人で自己紹介を済ませ、それぞれの作業に入った。純一は次のアプリのアイデアを考えていた。Haruは既存アプリのアップデートを進めていた。大学生はSwiftUIのチュートリアルを写経していた。

二時間後の成果発表タイム。

Haruが純一に言った。

「純一さん、もくもく会の主催を始めたのはすごくいい判断ですよ。コミュニティを運営する側に回ると、自然と人が集まってきます。最初は少人数でも、続けることが大事です」
...
実際、翌月のvol.2は参加者二名（純一とHaru）だった。純一は一人でも開催すると決めていたので、Haruが来てくれただけでも嬉しかった。vol.3は純一一人だけの回もあった。それでも純一は会場に行き、一人で作業し、Xに投稿した。
...
賞金総額は三十五万ドル——日本円にして五千万円以上。しかし純一にとって、賞金よりも重要だったのは三つ目の条件だ。Build in Public——純一がすでにやっていることだ。
...
純一は考えた。二つ目のアプリ。チュートリアルベースではなく、完全にゼロから作るオリジナルアプリ。サブスクリプション課金が自然に組み込めるもの。

純一は自分の経験を振り返った。iOSエンジニアを目指す中で、最も苦労したことの一つが@<b>{英語}だった。Swiftful Thinkingの動画は英語。Apple公式ドキュメントは英語。Stack Overflowの回答は英語。エラーメッセージも英語。iOSエンジニアにとって、英語は避けて通れない。
...
純一は@<code>{QuestionType}にenumを使った。第三章で学んだ@<code>{LocationCategory}と同じパターンだ。学んだ技術が、次のアプリで再利用できる。螺旋階段を上るように、少しずつ高い場所に到達している実感があった。
...
@<code>{@Published}と@<code>{ObservableObject}——第二章で学んだMVVMパターンがここでも活きる。ViewModel がデータと状態を管理し、Viewは表示に専念する。純一はこのパターンをKamakura Templeの@<code>{LocationsViewModel}で体得していたので、スムーズに書けた。
...
@<code>{Purchases.configure}でSDKを初期化する。APIキーはRevenueCatのダッシュボードから取得する。純一はダッシュボードにログインし、プロジェクトを作成し、App Store Connectの共有シークレットを入力した。
...
純一はApp Store Connectでサブスクリプション商品を作成した。月額プラン（480円）と年額プラン（4,800円）。RevenueCatのダッシュボードでEntitlement「premium」を作成し、両プランを紐づけた。
...
純一はこのコードをCursorと対話しながら書き上げた。一行ずつ、「なぜこう書くのか」を確認しながら。
...
純一はCursorに質問し、Stack Overflowを検索し、RevenueCatのDiscordコミュニティに質問を投げた。英語で。拙い英語だったが、コミュニティのメンバーが丁寧に回答してくれた。
...
SwiftLingoのアプリ自体は完成していた。リーディング問題、単語問題、スコアトラッキング、学習レポート——基本機能はすべて動いている。UIもデザイナーとしての技量を活かし、美しく仕上がっていた。純一はApp Storeに審査を提出し、三日後に承認された。二つ目のアプリリリース。
...
純一はApp Store Connectのステータスを一時間おきに確認した。「Waiting for Review」。「Waiting for Review」。変わらない。
...
純一は提出フォームの「Submit」ボタンの前で、五分間、固まっていた。
...
数日後、Shipatonの結果が発表された。純一の名前はリストになかった。@<b>{失格}。
...
//quote{
@mizuno_junichi 失格は悔しいですよね。でも2ヶ月でアプリ1本リリースして、課金の仕組みも一通り学べたのは大きい。RevenueCatの実装は一度経験すれば次は早いですよ。来年一緒にShipaton出ましょう！
//}

志村さんからもリプライが来た。

//quote{
@mizuno_junichi 海外のハッカソンにエントリーして、英語でBuild in Publicしたこと自体がすごい。結果は失格でも、過程で得たものは確実に残る。App Store Connect周りの知見は実務でも使うから、いい経験です。
//}

純一はリプライを読みながら、少しだけ気持ちが軽くなった。

失格は事実だ。しかし、純一の手元にはSwiftLingoというアプリと、RevenueCatの実装知識と、英語でBuild in Publicした経験がある。これらは、失格という結果では消えない。
...
一つ目はチュートリアルベースの改変アプリ。二つ目は完全にゼロから設計したオリジナルアプリ。純一の成長の軌跡が、App Storeに刻まれていた。

もくもく会の日。

「iOSエンジニア&デザイナーもくもく会 vol.6」。参加者は六名に増えていた。純一とHaru、大学生のWebデザイナー（vol.1からの常連）、SIerのAndroidエンジニア、フリーランスのUIデザイナー、そしてSwiftUI初心者の会社員。

成果発表タイムで、純一はShipatonの経験を共有した。失格になったこと、しかしアプリはリリースできたこと、RevenueCatの仕組みを学べたこと。

Haruが言った。

「純一さん、アプリ二つリリースしたのは本当にすごいですよ。これ、就活で武器になります」

「就活……ですか？」

「個人開発でアプリをリリースした経験って、企業から見ると@<b>{実行力の証明}なんですよ。特に純一さんの場合、デザイナーのバックグラウンドがあって、自分でアプリを設計して、リジェクト対応して、課金実装にも挑戦した。これ、ポートフォリオとしてかなり強い」

純一は、就活のことをまだ本気で考えていなかった。今はアプリを作ることに夢中で、就職活動は「いつか」の話だと思っていた。

しかしHaruの言葉が、純一の意識を変えた。

「あと、純一さんのGitHubのプロフィール、もう少し充実させた方がいいですよ。リポジトリの説明文とREADMEを整えると、採用担当者に見てもらいやすくなります。あと、このもくもく会の主催者っていう実績もLaprasやFindyに反映されるんで」

純一はメモを取った。GitHub。README。Lapras。Findy。まだ知らない世界が広がっている。

もくもく会が終わった後、純一は一人で渋谷の街を歩いた。

十ヶ月前の自分を思い出した。午前一時、MacBook Airの冷たい光の前で「これでいいのか」と呟いていた自分。デザインデータの色味を微調整するだけの日々に、息苦しさを感じていた自分。

今の純一は違う。App Storeに二つのアプリがあり、もくもく会を主催し、LT会で登壇し、海外のハッカソンにエントリーした。失敗もした。リジェクトされた。失格になった。しかし、そのすべてが純一のスキルとして、経験として、蓄積されている。

純一はスマートフォンを取り出し、メモ帳を開いた。
...
純一は渋谷駅に向かった。改札をくぐり、ホームのベンチに座る。

iPhoneのApp Storeを開いた。「Kamakura Temple」と「SwiftLingo」。二つのアイコンが並んでいる。Kamakura Templeの寺のアイコンは純一がFigmaでデザインした。SwiftLingoのアイコンは、英語のアルファベットとSwiftのロゴを組み合わせたデザインだ。

二つの星。

まだ小さい。ダウンロード数は両方合わせても百に届かない。広告収入はゼロ。サブスクリプションの売上もゼロ。

しかし、純一の星は確かにApp Storeの空に輝いている。

電車が来た。純一はiPhoneをポケットに入れ、立ち上がった。

帰ったら、Haruに教わったLaprasに登録しよう。そして三つ目のアプリのアイデアを考えよう。Haruが言っていた「AdMobの広告収入」——純一が次に挑戦すべき収益化の方法だ。
