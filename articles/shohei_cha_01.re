...
水野純一の部屋は、MacBook Airから放たれる冷たい光だけが支配していた。
...
床には読みかけのデザイン雑誌が散乱し、純一の心の混沌を映し出しているかのようだった。『AXIS』の最新号が開きっぱなしで、その上に『+DESIGNING』が無造作に重なっている。どちらも、買ったときは胸が高鳴ったはずだ。いまは、ただの紙の山にしか見えない。

水野純一は二十八歳。グラフィックデザイン制作会社のアシスタントデザイナーとして三年が過ぎた。

三年。

その数字を頭の中で転がすと、不思議なほど軽い。何も残していないから軽いのだと、純一は気づいていた。
...
純一はAdobe Illustratorの画面を見つめた。クライアントから戻ってきた修正依頼は今日で七回目。「もう少しポップに」「やっぱり落ち着いた感じで」「最初の案の方向性で、でも色は変えて」。堂々巡りの修正地獄。しかもこのデザインには純一の名前は載らない。アシスタントとは、そういうことだ。

デザイン事務所に就職したとき、純一は信じていた。いつか自分のデザインが世に出る。自分の名前で仕事ができるようになる。三年経って理解したのは、アシスタントから上がれるのはほんの一握りで、大半は消耗しきって業界を去るか、あるいは永遠にアシスタントのまま歳を重ねるかのどちらかだという現実だった。

純一はIllustratorを閉じ、ブラウザを開いた。特に見たいものがあるわけではない。ただ、この息苦しさから一瞬でも逃れたかった。

何か、自分の意志で、ゼロから形あるものを生み出したい。

そんな渇望が、息苦しさとなって喉元までせり上がってくる。

純一はブックマークバーに並んだサイトを眺めた。Behance、Dribbble、Pinterest——デザイナーなら誰でも見るポートフォリオサイトたち。でも今夜、純一の指はそのどれもクリックしなかった。
...
純一が言語交換ミートアップに参加したのは、正直に言えば、英語力を上げたかったからではなかった。

仕事以外の人間と話したかっただけだ。

会社のデザイナーたちとの会話は、いつもクライアントの愚痴か、Adobeソフトの新機能の話か、あるいは昨日のテレビの話題で終わる。もちろん嫌いではない。でも、その円環の中にいると、自分の世界がどんどん小さくなっていく気がした。

六本木の雑居ビルの三階。「Language Exchange Tokyo」と書かれた看板の先にある、バーを借り切った会場には、三十人ほどが集まっていた。日本語を学びたい外国人と、英語を練習したい日本人が、ビール片手に会話する。純一は壁際でハイボールを飲みながら、なかなか輪に入れずにいた。

「あの、日本の方ですか？」

声をかけてきたのは、純一と同い年くらいの男だった。黒のパーカーにジーンズ。首からAirPodsをぶら下げ、手にはiPhoneではなくAndroid端末を持っている。テック系の人間だと、直感的にわかった。

「はい。水野です。グラフィックデザイナーをしています」

「中野です。中野健太。モバイルエンジニアやってます。タクシー配車アプリの会社で」

モバイルエンジニア。純一にとっては、名刺交換のときに見かける肩書の一つでしかなかった。ウェブサイトを作るのがウェブエンジニアで、アプリを作るのがモバイルエンジニアなのだろう、くらいのざっくりした認識。

「グラフィックデザイナーですか！」

中野の目が輝いた。純一が思わず半歩引くほどの食いつきだった。

「いや、実はめちゃくちゃデザイナーさん探してたんですよ。俺、個人で開発してるアプリがあって。でもデザインが壊滅的で……。UIを触ってくれる人がいたら最高なんですけど」

UI。ユーザーインターフェース。その言葉なら純一も知っている。ウェブサイトやアプリの見た目を設計すること。デザイン会社でもUI案件は時々入ってくるが、純一が担当するのは主にバナーやチラシなどの印刷物だった。
...
純一は思わず笑った。ばかげている。でも、妙に心に刺さるコンセプトだった。既読スルーの罪悪感は、現代人なら誰しもが抱えている小さな棘だ。

「面白いですね、それ」

「でしょ？　で、来週の土曜日、渋谷のコワーキングスペースでもくもく会やるんだけど、来ない？　デザイン周りを見てもらえるとめちゃくちゃ助かる」

もくもく会。聞いたことはある。各自が自分の作業を黙々と進める集まりのこと。デザイン業界にも似たような勉強会があるが、純一は参加したことがなかった。

断る理由がなかった。というより、会社と自宅の往復以外の予定が入ること自体が、純一にとっては珍しいことだったのだ。

「行きます」

その一言が、水野純一の人生の分岐点だったと、後になって気づくことになる。
...
木のテーブルにMacBookが並び、観葉植物が窓辺に置かれ、BGMにローファイ・ヒップホップが流れている。純一がイメージしていた「エンジニアの作業場」——薄暗い部屋にモニターが三台並んでいるような——とはまるで違った。
...
藤原美咲は純一より少し年上に見えた。肩までの黒髪をひとまとめにし、眼鏡の奥から鋭い目でMacBookの画面を見つめている。後で聞けば、国内有数のモバイルゲーム会社でエンジニアとして働いているらしい。しかも、App Storeのゲームランキングで上位に入るようなタイトルの開発チームに所属しているという。

「水野さんはグラフィックデザイナーなんだって？」と美咲が言った。「Ignoreのアイコン、作ってもらえると嬉しいな。いま仮でフリー素材使ってるんだけど、やっぱりちゃんとしたのが欲しくて」

「もちろん。それくらいなら」

純一はMacBook Airを開き、Illustratorを起動した。アイコン制作なら、純一の専門だ。Ignoreのコンセプトを聞き、シンプルな吹き出しマークに「×」を組み合わせたアイコンを三案ほどスケッチした。
...
純一がアイコンを三案仕上げるのに二時間かかった。その間に、中野と美咲はチャット画面のリアルタイム更新機能を実装し終えていた。

「えっと……これ、いつから作ってるんですか？」

純一が恐る恐る聞くと、中野が軽い調子で答えた。

「先週の月曜からだから、ちょうど一週間かな」

一週間。

たった一週間で、メッセージの送受信ができて、プロフィールが設定できて、チャットルームを作成できるSNSアプリが形になっている。純一がこの一週間で作ったのは、化粧品ブランドのパンフレットの色校正と、飲食店のメニュー表の修正データだった。
...
宣言的。その言葉の意味はまだわからなかったが、「レイアウトの構造がそのままコードになる」という部分は、デザイナーの純一の心に強く引っかかった。

Illustratorでレイアウトを組むとき、純一は常に「この要素はここ、あの要素はあそこ」と配置を考える。それがコードとして書ける？

帰り際、純一はもう一度、シミュレータに映るIgnoreの画面を見つめた。中野と美咲が書いたコードが、iPhoneの形をしたウィンドウの中で動いている。自分がデザインしたアイコンが、そのアプリの顔として左上に鎮座している。
...
純一のMacBook Airには、XcodeもSwiftもインストールされていない。純一にできたのは、アイコンを作ることだけだった。その事実が、無力感と同時に、これまで感じたことのない強烈な@<b>{憧れ}として胸の奥に刻まれた。


=== Xcodeという名の扉

午前一時。三週間前の記憶から引き戻された純一は、MacBook Airの画面を見つめていた。
...
AppleのDeveloperページを開く。Xcodeの容量表示を見て、純一は目を疑った。
...
「Create New Project」をクリックする。テンプレート選択画面が現れた。App、Document App、Game、Augmented Reality App——。選択肢の多さに、純一は一瞬たじろいだ。おそらく「App」を選べばいいのだろう。
...
純一はキーボードに手を置いた。@<code>{Text("Hello, World!")}の文字列を書き換えてみる。

//list[first_edit][最初の編集][swift]{
Text("こんにちは、世界。水野純一、28歳。")
//}

右側のプレビューが、即座に更新された。iPhoneの画面に「こんにちは、世界。水野純一、28歳。」という文字が表示されている。
...
純一はチュートリアルを開いた。英語だった。技術英語は翻訳ツールを使いながら読み進めることにした。
...
@<code>{.clipShape(Circle())}で画像を円形にクリッピングし、@<code>{.overlay}で白い枠線を重ね、@<code>{.shadow}でドロップシャドウを付ける。純一はPhotoshopでまったく同じ処理をしたことが何十回もある。レイヤーマスクで円形に切り抜き、レイヤースタイルで境界線を追加し、ドロップシャドウを適用する。あの手順が、たった四行のコードで完結する。

「すごいな……」

純一は独り言を言い、すぐに苦笑した。デザイナーが「コードが美しい」と思うなんて、三週間前の自分には想像もできなかった。
...
純一は土日をほぼすべてチュートリアルに費やした。月曜日の朝、出社前にも三十分だけ触った。火曜日の夜も、水曜日の昼休みも。

Landmarksチュートリアルは全七章。純一は一週間かけて、第五章まで進んだ。
...
第五章。アニメーションとトランジションを実装するセクションで、純一のXcodeが赤く染まった。
...
純一は何が起きたのか理解できなかった。チュートリアルの通りにコードを書いたはずだ。一文字ずつ、丁寧に。しかし、Xcodeは無慈悲にエラーを吐き続ける。
...
純一はまずGoogle検索を試みた。エラーメッセージをそのまま貼り付ける。英語の検索結果が並ぶ。Stack Overflowというサイトが頻繁にヒットした。プログラマーの質疑応答サイトらしい。

回答を読むが、「@<code>{@Binding}を使ってください」としか書かれていない。@<code>{@Binding}とは何か。チュートリアルにも登場していたが、純一の理解が追いついていなかった。
...
@<code>{$isOn}——変数名の前に@<code>{$}を付けると、@<code>{Binding}になるらしい。しかし、なぜBindingが必要なのか。なぜ単なるBoolではだめなのか。純一の頭の中はIllustratorのベクターパスのように複雑に絡まっていた。
...
午前三時。純一は椅子の背にもたれかかり、天井を見上げた。

Neville Brodyが見下ろしている。

純一は唇を噛んだ。デザインツールなら、何時間でも戦える。Illustratorのペンツールで思い通りの曲線が引けなくても、何度でもやり直せる。それは「技術の習熟」であり、反復が確実に成果に結びつく。しかしプログラミングのエラーは違う。コードが正しいか間違っているか、0か1かの世界。99%合っていても、残り1%が間違っていれば動かない。

これが、デザイナーとエンジニアの世界の違いなのか。

純一は諦めかけていた。やはり自分にはプログラミングは向いていないのではないか。デザインの世界に戻るべきではないか。
...
投稿した瞬間、純一は後悔した。こんな初歩的な質問を公の場に晒して、笑われるのではないか。「ググれ」と言われるのではないか。
...
純一はコードを書き直した。チュートリアルのHikeViewに、正しく@<code>{@Binding}を設定する。ビルドボタンを押す。
...
純一は小さくガッツポーズをした。午前四時。窓の外はまだ暗いが、純一の心の中には確かに光が差していた。
...
//quote{
水野純一｜グラフィックデザイナー → iOSアプリ開発勉強中｜SwiftUI学習記録
//}
...
純一はまず「SwiftUI Bootcamp」というプレイリストから視聴を始めた。
...
純一はデザイナーとして即座に理解した。これはCSSのテキストプロパティと同じだ——いや、もっと直感的だ。@<code>{.font(.title)}と書けばタイトルサイズになる。@<code>{.foregroundStyle(.red)}で赤くなる。@<code>{.italic()}でイタリック体になる。
...
純一は動画を一時停止し、自分のXcodeで同じコードを書いてみた。プレビューに青い角丸のボタンが表示される。タップすると——プレビュー上ではわからないが、コンソールに「ボタンが押されました」と出力される。
...
純一はZStackの仕組みを理解した。@<code>{ZStack}はレイヤーの重なりだ。Illustratorでいう「前面に配置」「背面に配置」と同じ。ZStackの中に書いた順に、下から上にレイヤーが積まれる。最初に書いたものが最背面、最後に書いたものが最前面。

昼休みの四十五分では足りなかった。純一は帰宅後、毎晩二時間をSwiftful Thinkingの視聴に充てた。通勤の電車内でもイヤホンで視聴した。
...
デザイナーの純一にとって、SwiftUIのコンポーネントはデザインツールのパーツパレットに見えた。Illustratorのツールバーに並ぶ長方形ツール、楕円ツール、テキストツールと同じように、SwiftUIにも用途ごとのコンポーネントがある。違うのは、それが「動く」ということだ。
...
Swiftful Thinkingの動画を三十本ほど消化し、Apple公式チュートリアルも最後まで完走した頃、純一の中に一つの衝動が芽生えた。

チュートリアルの写経はもう十分だ。@<b>{自分のアプリを作りたい。}

何を作るか。純一は悩んだ。中野と美咲のようにSNSアプリを作る技術は、まだない。地図アプリもまだ早い。初めてのアプリは、シンプルな方がいい。

Todoアプリ。

タスク管理ツールとしてのTodoアプリは、プログラミング学習の「Hello, World!」の次に来る定番プロジェクトだ。データの追加、表示、削除、更新——いわゆるCRUD操作を一通り学べる。

純一はXcodeで新しいプロジェクトを作成した。Product Nameは「MyTodo」。

まず、Todoのデータ構造を考える。デザイナーとして、UIを先に考えるのが純一の自然な発想だった。
...
純一は志村さんに教わった@<code>{@State}を思い出しながら、メイン画面を作り始めた。
...
完了済みのTodoには取り消し線を引き、テキスト色をグレーにする。チェックマークは緑色に変わる。デザイナーの血が騒ぎ、純一は視覚的なフィードバックにこだわった。
...
ここで純一は@<code>{@Binding}を使った。志村さんに教わったあの概念だ。
...
純一はコードを何度も修正し、UIを磨いた。色の選択、フォントサイズ、余白のバランス——ここはデザイナーの腕の見せどころだ。エンジニアが「とりあえず動けばいい」と作るUIとは一線を画する、視覚的に心地よいTodoアプリを目指した。
...
純一のTodoアプリでは、パターン1と2を使っている。パターン3は、アプリが複雑になったときに必要になる技術だ。
//}
...
シミュレータが起動する。iPhone 15 Proの画面が純一のMacBook Airに映し出された。

「My Todo」というタイトルの画面。右上に「＋」ボタン。中央には「Todoがありません」というメッセージとチェックリストのアイコン。

純一は「＋」ボタンをタップした。モーダルが下からスライドして現れる。テキストフィールドに「SwiftUIをもっと学ぶ」と入力。「追加」ボタンを押す。
...
純一は左にスワイプした。赤い「Delete」ボタンが現れる。タップすると、行がアニメーションとともに消えた。

すべてが、自分の書いたコードの通りに動いている。

純一はしばらく、シミュレータの画面を見つめていた。

このアプリには、クライアントの要望も、上司の指示も、ディレクターのフィードバックもない。色の選択も、フォントの選択も、レイアウトの設計も、すべて純一が決めた。そして、そのデザインが「動く」ものとして目の前に存在している。
...
三週間前——いや、つい最近まで、純一は毎日の繰り返しの中で窒息しそうだった。デザイン会社での歯車としての日々。「これでいいのか」という自問自答。何を検索すればいいかもわからない焦燥感。
...
純一はXcodeのメニューから新しいSwiftファイルを作成した。ファイル名は「MapView.swift」。

Swiftful Thinkingの次のプレイリスト——「Map App」のチュートリアル。地図アプリの作り方を学ぶシリーズだ。Landmarksチュートリアルで少しだけ触れた@<code>{MapKit}を、もっと深く掘り下げる内容。

純一はYouTubeのSwiftful Thinkingのチャンネルを開き、「Map App」プレイリストの第一話を再生した。

午前一時。

水野純一のMacBook Airは、もう冷たい光ではなかった。

Xcodeのカラフルなシンタックスハイライトが、純一の顔を暖かく照らしている。青と紫と緑とオレンジ。コードの中に、純一の未来が書かれ始めていた。
